...
- **古诗词**（原生 HTML + CSS + JS）—— 诗句修复 12 关，42 首唐诗宋词，4 / 5 / 6 个选项逐关变难
...
- 题库从 14 首扩到 **42 首**（15 首五言短诗 + 16 首七言绝句 + 11 首律诗与词），关卡从 5 关扩到 **12 关**：每档随机抽 4 首，由易到难排列，重玩时题目会变
- 难度递进：第 1-4 关 4 个选项、5-8 关 5 个、9-12 关 6 个，且高关卡不再按字数筛干扰项，选项更难排除
